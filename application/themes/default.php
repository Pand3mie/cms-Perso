...
<html class="bg-black">
    <head>
        ...
        <!-- Ionicons -->
        <link rel="stylesheet" type="text/css" href="<?php echo css_url('ionicons.min'); ?>">
        <!-- Morris chart -->
        <link rel="stylesheet" type="text/css" href="<?php echo css_url('morris/morris'); ?>">
        <!-- jvectormap -->
        <link rel="stylesheet" type="text/css" href="<?php echo css_url('jvectormap/jquery-jvectormap-1.2.2'); ?>">
        <!-- fullCalendar -->
        <link rel="stylesheet" type="text/css" href="<?php echo css_url('fullcalendar/fullcalendar'); ?>">
        <!-- Daterange picker -->
        <link rel="stylesheet" type="text/css" href="<?php echo css_url('daterangepicker/daterangepicker-bs3'); ?>">
        <!-- bootstrap wysihtml5 - text editor -->
        <link rel="stylesheet" type="text/css" href="<?php echo css_url('bootstrap-wysihtml5/bootstrap3-wysihtml5.min'); ?>">
    ...
    <body class="bg-black">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li><!-- start message -->
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?php echo img_url('avatar3'); ?>" class="img-circle" alt="User Image"/>
                                                </div>
                                                <h4>
                                                    Support Team
        ...
        <!-- jQuery UI 1.10.3 -->
        <script src="<?php echo js_url('jquery-ui-1.10.3.min'); ?>" type="text/javascript"></script>
        <!-- Bootstrap -->
        <script src="<?php echo js_url('bootstrap.min'); ?>" type="text/javascript"></script>
        <!-- Morris.js charts -->
        <script src="//cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
        <script src="<?php echo js_url('plugins/morris/morris.min'); ?>" type="text/javascript"></script>
        <!-- Sparkline -->
        <script src="<?php echo js_url('plugins/sparkline/jquery.sparkline.min'); ?>" type="text/javascript"></script>
        <!-- jvectormap -->
        <script src="<?php echo js_url('plugins/jvectormap/jquery-jvectormap-1.2.2.min'); ?>" type="text/javascript"></script>
        <script src="<?php echo js_url('plugins/jvectormap/jquery-jvectormap-world-mill-en'); ?>" type="text/javascript"></script>
        <!-- fullCalendar -->
        <script src="<?php echo js_url('plugins/fullcalendar/fullcalendar.min'); ?>" type="text/javascript"></script>
        <!-- jQuery Knob Chart -->
        <script src="<?php echo js_url('plugins/jqueryKnob/jquery.knob'); ?>" type="text/javascript"></script>
        <!-- daterangepicker -->
        <script src="<?php echo js_url('plugins/daterangepicker/daterangepicker'); ?>" type="text/javascript"></script>
        <!-- Bootstrap WYSIHTML5 -->
        <script src="<?php echo js_url('plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min'); ?>" type="text/javascript"></script>
        <!-- iCheck -->
        <script src="<?php echo js_url('plugins/iCheck/icheck.min'); ?>" type="text/javascript"></script>

        <!-- AdminLTE App -->
        <script src="<?php echo js_url('AdminLTE/app'); ?>" type="text/javascript"></script>
        
        <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
        <script src="<?php echo js_url('AdminLTE/dashboard'); ?>" type="text/javascript"></script>     
        
        <!-- AdminLTE for demo purposes -->
        <script src="<?php echo js_url('AdminLTE/demo'); ?>" type="text/javascript"></script>
